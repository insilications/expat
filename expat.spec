...
Source0  : https://sourceforge.net/projects/expat/files/expat/2.2.3/expat-2.2.3.tar.bz2
...
%prep
%setup -q -n expat-2.2.3
pushd ..
cp -a expat-2.2.3 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1501843785
export AR=gcc-ar
...
/usr/lib64/libexpat.so.1.6.5

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libexpat.so.1
/usr/lib32/libexpat.so.1.6.5
