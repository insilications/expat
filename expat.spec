...
Source0  : https://sourceforge.net/projects/expat/files/expat/2.2.4/expat-2.2.4.tar.bz2
...
%prep
%setup -q -n expat-2.2.4
pushd ..
cp -a expat-2.2.4 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1503268481
export AR=gcc-ar
...
/usr/lib64/libexpat.so.1.6.6

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libexpat.so.1
/usr/lib32/libexpat.so.1.6.6
