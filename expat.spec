...
Source0  : https://sourceforge.net/projects/expat/files/expat/2.2.1/expat-2.2.1.tar.bz2
...
%prep
%setup -q -n expat-2.2.1
pushd ..
cp -a expat-2.2.1 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1497818268
export AR=gcc-ar
...
/usr/lib64/libexpat.so.1.6.3

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libexpat.so.1
/usr/lib32/libexpat.so.1.6.3
